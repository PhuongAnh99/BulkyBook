...
namespace BulkyBookWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPOST()
        {
            ...
            ShoppingCartVM.ListCart = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == claim.Value, "Product");
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            if (cart.Count <= 1)
            {
                ...
                _HttpContextAccessor.HttpContext.Session.SetInt32(SD.SessionCart, count);
            }
            else
            {
